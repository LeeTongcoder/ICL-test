...
def main():
    ...
    parser.add_argument("--data_name", default="Sports_and_Outdoors500", type=str)
    ...
    # args.data_name = 'Sports_and_Outdoors500'
    ...
    # 以上所有初始化模型，初始化参数完成，下面开始正式训练
        ...
        # load the best model
        trainer.model.load_state_dict(torch.load(args.checkpoint_path))     # 加载模型参数
        scores, result_info = trainer.test(0, full_sort=True)
